...
RSpec.describe "Posts with authentication", type: :request do
    ...
    #En el header por convencion se usa:
    #Authorization: Bearer xxxxxxx
    describe " GET /posts/{id}" do
        #Otra forma de darle contexto a las pruebas
    ...
    describe " POST /posts/{id}" do
        #Con autenticacion se puede crear
        ...
        #sin autenticacion no se puede crear
    ...
    describe " PUT /posts/{id}" do
        #con autenticacion se puede actualizar un post nuestro pero no de otro 401
        context "with valid authentication" do
    ...
    private 
    def payload
        #Nos permite acceder a los campos de la respuesta tanto con hashes :id como con strings
